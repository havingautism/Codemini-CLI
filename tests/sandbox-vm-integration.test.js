...
test('real microsandbox VM executes a command in /workspace', { timeout: 240_000 }, async (t) => {
  if (!ENABLED) {
  ...
  assert.equal(code, 0, `exit code 0; stderr: ${stderr.slice(0, 500)}`);
