export const en = {
  ...
  planReviseHint: 'Describe how you want the plan adjusted. The AI will regenerate the pending plan from your feedback.',
  planSaving: 'Saving…',
  planReviewUserApproved: '[Plan review] Approved the plan for execution',
  planReviewUserRejected: '[Plan review] Rejected the pending plan',
  ...
  planReviewEditedAssistant: 'Plan manually updated and still waiting for approval, further revision, or rejection.',
  ...
  planMode: 'Engineering',
  planModeDesc: 'Explore first, then create a spec or plan for review before execution',
  specMode: 'Spec',
