          ...
          {sections.length === 0 ? (
            ...
            sections.map(([label, value], i) => (
              <div key={i}>
                ...
                <pre className="m-0 p-2 rounded bg-[var(--bg-tertiary)] text-[var(--text-primary)] font-mono text-xs leading-relaxed overflow-x-auto whitespace-pre-wrap break-words">
                  {value}
                </pre>
              </div>
            ))
