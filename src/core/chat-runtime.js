  ...
  return {
    zh: {
      configLabels: {
        ...
        'context.aggressive_tool_prune_keep_recent': '激进压缩保留最近工具结果数',
      ...
      optionHints: {
        ...
        'context.aggressive_tool_prune_keep_recent': '建议：1-3',
    ...
    en: {
      configLabels: {
        ...
        'context.aggressive_tool_prune_keep_recent': 'aggressive prune keep recent tool results',
      ...
      optionHints: {
        ...
        'context.aggressive_tool_prune_keep_recent': 'recommended: 1-3',
