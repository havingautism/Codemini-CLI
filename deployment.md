...
```text
codemini-cli-0.5.1.tgz
```

If you want to verify the package contents:

```bash
tar -tf codemini-cli-0.5.1.tgz
```
...
```powershell
npm install -g C:\temp\codemini-cli-0.5.1.tgz
```
...
cd C:\temp\coder-test
npm install C:\temp\codemini-cli-0.5.1.tgz
```
